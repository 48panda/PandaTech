...
public abstract class RedstoneArmorItem extends ArmorItem {
	...
	public static class Helmet extends RedstoneArmorItem {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(PandaTechTabs.TAB_ELECTROCUTION_CREATIVE_TAB));
		}
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "panda_tech:textures/models/armor/redstone_layer_1.png";
		}
	}

	public static class Chestplate extends RedstoneArmorItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(PandaTechTabs.TAB_ELECTROCUTION_CREATIVE_TAB));
		}
	...
	public static class Leggings extends RedstoneArmorItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(PandaTechTabs.TAB_ELECTROCUTION_CREATIVE_TAB));
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "panda_tech:textures/models/armor/redstone_layer_2.png";
		}
	}

	public static class Boots extends RedstoneArmorItem {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(PandaTechTabs.TAB_ELECTROCUTION_CREATIVE_TAB));
		}
