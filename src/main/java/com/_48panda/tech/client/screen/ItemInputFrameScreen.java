...
public class ItemInputFrameScreen extends ExtendedContainerScreen<ItemInputFrameContainer> {
    public ItemInputFrameScreen(ItemInputFrameContainer container, Inventory playerInv, Component title) {
