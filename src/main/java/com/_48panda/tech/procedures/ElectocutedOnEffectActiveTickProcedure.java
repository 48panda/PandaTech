...
public class ElectocutedOnEffectActiveTickProcedure {
	public static void execute(Entity entity, double amplifier) {
		...
		armorPieces = 0;
		if (PandaTechItems.REDSTONE_ARMOR_BOOTS
