...
public abstract class FurnaceConsumer extends AbstractFurnaceBlock {
    public FurnaceConsumer(BlockBehaviour.Properties props) {
        super(props);
    }
    @Override
    ...
    public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
        ...
        if (data.getBoolean("hasNetworkManager")) {
            ...
            CompoundTag nwm_data = world.getBlockEntity(sendToPos).getTileData();
    ...
    public void update(ServerLevel world, BlockPos pos) {
        BlockEntity be = world.getBlockEntity(pos);
        CompoundTag data = be.getTileData();
        if (data.getBoolean("hasNetworkManager")) {
            int[] NetworkManagerPos = data.getIntArray("networkManagerPos");
