...
public class EnergyCableContainerData extends AbstractCableContainerData{
    public EnergyCableContainerData(AbstractCableBlockEntity be, int size, Direction face) {
        super(be, size, face);
    }
